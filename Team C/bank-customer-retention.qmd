...
### churn by products {.tabset}

::: {.card title="Top 10 products churn rate"}  
Product sorted in descending order of churn rates.

```{r}
#| lable: top 10 bank product churn rate
...
::: {.card title="Bottom 10 products churn rate"}  
